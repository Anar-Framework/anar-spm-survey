package af.gov.anar.spm.sample.api;
...
import af.gov.anar.spm.sample.service.SampleEntityService;
import af.gov.anar.spm.infrastructure.exception.UnAuthorizedException;
